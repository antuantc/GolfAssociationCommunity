...
namespace GolfAssociationCommunity.Pages.Admin.Transactions
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public DetailsModel(IAuthorizeNetTransactionService transactionService, IAdminAuditService adminAuditService)
        {
        ...
        public async Task<IActionResult> OnPostRefundAsync(string sourceType, int id)
        {
            ...
            var refundResult = await _transactionService.RefundTransactionAsync(SourceType, Id, refundAmount);
        ...
        {
            Transaction = await _transactionService.GetTransactionAsync(SourceType, Id);
        }
